<?php 
    ...
    class CategoryManager {
        ...
        public function add(Category $category){
            ...
            $sth->bindParam(':name', $category->name(), PDO::PARAM_STR);
            if($sth->execute()){
                return true;
            }else{
                return false;
        ...
        public function get($id){
            ...
            $sql = "SELECT c.id, c.name AS 'Nom catégorie' 
            ...
            //TODO : a mettre dans partie method = read
            // if($result){
        ...
        public function update(Category $category){
            ...
            $sth = $this->_connection->prepare($sql);
            $sth->bindParam(':name', $category->name(), PDO::PARAM_STR);
            $sth->bindParam(':id', $category->id(), PDO::PARAM_INT);
            if($sth->execute()){
                return true;
            }else{
                return false;
